	...
	<div>
		...
		<form action="viewdiff.php" method="post">
			...
			<div class="panecontainer" style="display:inline-block;width:49.5%">
				<p>From</p>
				<div><textarea name="from" class="pane"><?php echo htmlentities($from_text, ENT_QUOTES, 'UTF-8'); ?></textarea></div>
			</div>
			<div class="panecontainer" style="display:inline-block;width:49.5%">
				<p>To</p>
																							...
																							echo ' checked="checked"';
																																												...
																																												echo ' checked="checked"';
																																																															...
																																																															echo ' checked="checked"';
																																																																																	...
																																																																																	echo ' checked="checked"';
																																																																																} ?>>&thinsp;Character&emsp;<input type="submit" value="View diff">&emsp;<a href="viewdiff.php"><button>Clear all</button></a></p>
		</form>
